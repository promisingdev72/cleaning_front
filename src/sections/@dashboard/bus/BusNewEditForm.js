...
export default function BusNewEditForm({ isEdit, currentBus }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      email: currentBus?.email || '',
      phoneNumber: currentBus?.phoneNumber || '',
      address: currentBus?.address || '',
      country: currentBus?.country || '',
      state: currentBus?.state || '',
      city: currentBus?.city || '',
      zipCode: currentBus?.zipCode || '',
      avatarUrl: currentBus?.avatarUrl || '',
      isVerified: currentBus?.isVerified || true,
      status: currentBus?.status,
      company: currentBus?.company || '',
      role: currentBus?.role || '',
    }),
